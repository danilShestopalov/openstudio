    ...
    <section class="post">
        <div>
            <form action="{{ route('profile.store') }}" method="post" enctype="multipart/form-data">
                ...
                <label for="prodname">Nickname</label>
                <input type="text" placeholder="" name="nickname" id="prodname">
                <label for="prodname">About myself</label>
                <input type="text" placeholder="" name="about" id="prodname">
                <label for="desc">Contacts</label>
                <input type="text" placeholder="" name="contacts" id="desc">
                <select-tags-component url="/api/profile/professions" name="professions"></select-tags-component>
                <select-tags-component url="/api/profile/skills" name="skills"></select-tags-component>
                <div class="picss">
                    <div>
                        <label for="">Avatar</label>
                        <div class="svg">
                            <svg width="108" onclick="document.getElementById('avatar').click();" height="90" viewBox="0 0 108 90" fill="none" xmlns="http://www.w3.org/2000/svg">
